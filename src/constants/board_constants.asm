...
DEF BOARDSTRUCT_OPP_ATK_METER_TILEMAP    RB 3
DEF BOARDSTRUCT_OPP_ATK_METER_ATTRMAP    RB 3
DEF BOARDSTRUCT_2P_OPP_ATK_METER_TILEMAP RB 3
DEF BOARDSTRUCT_2P_OPP_ATK_METER_ATTRMAP RB 3
